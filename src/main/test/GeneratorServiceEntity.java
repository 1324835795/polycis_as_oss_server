...
public class GeneratorServiceEntity {
    ...
    public void generateCode() {
        ...
        generateByTables(serviceNameStartWithI, packageName, "dev_data_warn");
    }

//"lo_network_server","lo_network_system","lo_network_config","lo_network_config_info"
    private void generateByTables(boolean serviceNameStartWithI, String packageName, String... tableNames) {
        GlobalConfig config = new GlobalConfig();
        String dbUrl = "jdbc:mysql://192.168.10.156:3306/polycis_ns_send";
       ...
       // strategyConfig.entityTableFieldAnnotationEnable(true);//生成实体类属性的对应数据库字段注解
        ...
        config.setOutputDir("D:\\LORA_DEVELOP\\polycis_iot_platform\\polycis_as_main_server\\src\\main\\java");
                ...
                .setCfg(
                        ...
                        new InjectionConfig() {
                            ...
                            public String outputFile(TableInfo tableInfo) {
                                ...
                                return "D:/LORA_DEVELOP/polycis_iot_platform/polycis_as_main_server/src/main/resources/mybatis/" + tableInfo.getEntityName() + "Mapper.xml";
                            }
                        }))
